...
public class PythonAwsApigatewayDynamodbCodegen extends PythonAbstractConnexionServerCodegen {
    private static final Logger LOGGER = LoggerFactory.getLogger(PythonAwsApigatewayDynamodbCodegen.class);

    public PythonAwsApigatewayDynamodbCodegen() {
        super("python-aws-apigateway-dynamodb", false);
    }
    ...
    public String getName() {
        return "python-aws-apigateway-dynamodb";
    }
